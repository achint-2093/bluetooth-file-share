...
import com.techuntried.bluetoothshare.data.BluetoothDataTransferService
import com.techuntried.bluetoothshare.data.BluetoothStateReceiver
import com.techuntried.bluetoothshare.data.DeviceFoundReceiver
...
class AndroidBluetoothController(
    ...
    override suspend fun trySendMessage(message: String): BluetoothMessage? {
        ...
        dataTransferService?.sendMessage(com.techuntried.bluetoothshare.domain.toByteArray())
    ...
    private fun updatePairedDevices() {
        ...
        bluetoothAdapter
            ?.bondedDevices
            ?.map { com.techuntried.bluetoothshare.domain.toBluetoothDeviceDomain() }
            ?.also { devices ->
